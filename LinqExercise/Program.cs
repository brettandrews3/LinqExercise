...
namespace LinqExercise
{
    class Program
    {
         ...
         static void Main(string[] args)
        {
            ...
            //given input x, return x; works like a foreach loop
            Console.WriteLine("----------------------------");
            ...
            Console.WriteLine("---------------------");
            Console.WriteLine("What's my age again? Oh yeah--it's:");
            ...
            // for each person in persons, return back where their first letter at index [0] equals C
